package he.quanzhao.tinnews.ui.detail;
...
import he.quanzhao.tinnews.databinding.FragmentSavedNewsDetailBinding;
...
public class SavedNewsDetailFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("SavedNewsDetailFragment", article.toString());
